-- Focused tests for the config.translation workflow.
...
local previous_HTTPS_PROXY = vim.env.HTTPS_PROXY
local previous_lower_all_proxy = vim.env.all_proxy
local previous_upper_all_proxy = vim.env.ALL_PROXY
...
vim.env.HTTPS_PROXY = previous_HTTPS_PROXY
vim.env.all_proxy = previous_lower_all_proxy
vim.env.ALL_PROXY = previous_upper_all_proxy
